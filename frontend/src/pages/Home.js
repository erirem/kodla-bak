            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="space-x-2">
                    <button
                        ...
                        className="bg-indigo-100 text-indigo-700 font-medium px-4 py-2 rounded-lg hover:bg-indigo-200 transition duration-200 shadow-sm"
                    >
                        📚 Geçmiş
                    </button>
                    <button
                        onClick={onLogout}
                        className="bg-rose-500 text-white font-medium px-4 py-2 rounded-lg hover:bg-rose-600 transition duration-200 shadow-sm"
                    >
                        🚪 Çıkış Yap
                    </button>
                </div>
        ...
        />
                ...
                {loading && (
                    <div className="flex items-center justify-center text-sm text-gray-500 mt-2">
                        <svg className="animate-spin h-5 w-5 mr-2 text-indigo-600" xmlns="http://www.w3.org/2000/svg"
                ...
                {(resultText || codeBlock) && (
                    <div className="bg-white p-4 mt-4 rounded-lg border">
                        <h2 className="text-lg font-semibold text-indigo-700 border-l-4 border-indigo-600 pl-4 mb-3">AI
                            Geri Bildirim</h2>
